 @extends('admin.layouts.master',['navItem' => 'dashboard'])
                 ...
                 <div class="card">
                     ...
                     <div class="body">
                         <ul class="list-unstyled list-referrals">
                             <li>
                                 <p><span class="value">2301</span><span class="text-muted float-right">visits from
                                         Facebook</span></p>
                                 <div class="progress progress-xs">
                                     <div class="progress-bar bg-indigo" data-transitiongoal="87" aria-valuenow="87"
                                         role="progressbar" style="width: 87%;"></div>
                                 </div>
                             </li>
                             <li>
                                 <p><span class="value">2107</span><span class="text-muted float-right">visits from
                                         Twitter</span></p>
                                 <div class="progress progress-xs">
                                     <div class="progress-bar bg-orange" data-transitiongoal="34" aria-valuenow="34"
                                         role="progressbar" style="width: 34%;"></div>
                                 </div>
                             </li>
                             <li>
                                 <p><span class="value">2308</span><span class="text-muted float-right">visits from
                                         Search</span></p>
                                 <div class="progress progress-xs">
                                     <div class="progress-bar bg-purple" data-transitiongoal="54" aria-valuenow="54"
                                         role="progressbar" style="width: 54%;"></div>
                                 </div>
                             </li>
                             <li>
                                 <p><span class="value">1024</span><span class="text-muted float-right">visits from
                                         Affiliates</span></p>
                                 <div class="progress progress-xs">
                             ...
                             <tbody>
                                 <tr>
                                     ...
                                     <td class="align-right"><span
                                             class="badge badge-lg badge-pill badge-success text-uppercase">40%</span></td>
                                 </tr>
                                 <tr>
                                     <td>Mozila Firefox</td>
                                     <td class="align-right"><span
                                             class="badge badge-lg badge-pill badge-primary text-uppercase">30%</span></td>
                                 </tr>
                                 <tr>
                                     <td>Safari</td>
                                     <td class="align-right"><span
                                             class="badge badge-lg badge-pill badge-tertiary text-uppercase">15%</span></td>
                                 </tr>
                                 <tr>
                                     <td>Internet Explorer</td>
                                     <td class="align-right"><span
                                             class="badge badge-lg badge-pill badge-primary text-uppercase">15%</span></td>
                                 </tr>
                             </tbody>
                         </table>
                     </div>
             ...
             <div class="col-lg-4">
                 <div class="card">
                     ...
                     <div class="card-image">
                         <img src="{{ URL::to('/assets/images/image-gallery/5.jpg') }}" alt="" class="img-fluid">
                     </div>
                     <div class="card-body">
                         <div class="row mb-1">
                             <div class="col">
