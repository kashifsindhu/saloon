    ...
    <div class="container-fluid ">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h5 class="d-inline">Add Product</h5>
            ...
            <div class="card-body">
                <form action="{{ URL::to('/') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-8 mx-auto">
                        ...
                        {{-- price --}}
                        <div class="col-md-8 mb-4">
                            <label for="price"><strong>Price: <sup class="text-danger">*</sup></strong></label>
                            <input type="number" class="form-control mb-3" name="price" id="price" required>
                        </div>
