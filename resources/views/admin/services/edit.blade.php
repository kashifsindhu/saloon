@extends('admin.layouts.master',['navItem'=>'EditService'])
@section('content')
                ...
                <form action="{{ route('services.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 ">
                            ...
                            <input type="text" class="form-control mb-3" name="title1" id="title1" required>
                        </div>
                        {{-- Title 2 --}}
                        <div class="col-md-4 ">
                            <label for="title2"><strong>Title 2: <sup class="text-danger">*</sup></strong></label>
                            <input type="text" class="form-control mb-3" name="title2" id="title2" required>
                        </div>
